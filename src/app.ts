...
const TEXTURE_PATH = new URL("./grid.png", import.meta.url).href;
const DISPLACEMENT_PATH = new URL("./displacement.png", import.meta.url).href;
const METALNESS_PATH = new URL("./metalness.png", import.meta.url).href;
...
// Light
// Ambient Light
const ambientLight = new THREE.AmbientLight("#2222ff", 10);
scene.add(ambientLight);

// Right Spotlight aiming to the left
const spotlight = new THREE.SpotLight("#ff33ff", 20, 25, Math.PI * 0.1, 0.25);
...
const spotlight2 = new THREE.SpotLight("#ff33ff", 20, 25, Math.PI * 0.1, 0.25);
